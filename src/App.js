...
export default function App() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "👋 Hi! I'm your AI budget advisor. Add your income and expenses, then ask me anything — like 'Am I overspending?' or 'Give me a monthly report'.",
    },
  ]);
  ...
  useEffect(() => {
    ...
    const spendPercent =
      savedIncome > 0 ? (totalExpenses / savedIncome) * 100 : 0;
      ...
      <div style={{ padding: "24px", maxWidth: 860, margin: "0 auto" }}>
        {tab === "dashboard" && (
          <Dashboard
            ...
            setCategoryGoals={setCategoryGoals}
            darkMode={darkMode}
            currency={currency}
        ...
        {tab === "profile" && <Profile user={user} darkMode={darkMode} />}
      </div>
      ...
      {showResetModal && (
        ...
        >
          ...
          >
            ...
            >
              It's a new month! Do you want to reset your expenses and start
              fresh?
            </div>
